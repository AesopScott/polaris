...
if (!Object.isFrozen(p1.allowedRoots)) throw new Error('allowedRoots array not frozen');
...
// Test 2: restricted session (no workDir) — allowedRoots must be empty
...
if (!Object.isFrozen(p2.allowedRoots)) throw new Error('restricted allowedRoots not frozen');
